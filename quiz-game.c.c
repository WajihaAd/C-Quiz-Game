...
//    printf("\n    general knowledge. You are eligible to play the game if you give atleast 2");
    ...
    printf("\n    total of 14 questions. Each right answer will be awarded $1000!");
    printf("\n    By this way you can win upto $14000 cash prize!!!!!..........");
...
game:
	...
	if(score>0.00 && score<14000)
	{
	   printf("\n\n\t\t****** CONGRATULATION *******");
	     printf("\n\t You won $%.2f",score);goto go;}

	 else if(score==14000.00)
	{
	    printf("\n\n\n \t\t****** CONGRATULATION ******");
...
void help()
    ...
    printf("\n    total 23 questions each right answer will be awarded $1000.");
    printf("\n    By this way you can win upto $14000 cash prize in USD...............");
    printf("\n >> You will be given 4 options and you have to press A, B ,C or D for the");
    printf("\n    right option");
    printf("\n >> You will be asked questions continuously if you keep giving the right answers.");
    
	printf("\n\n\t********BEST OF LUCK************");
	printf("\n\n\t**C PROGRAM QUIZ GAME is developed by wajiha adnan***");}

void edit_score(float score, char name[20])
	{system("cls");
	float sc;
	char nm[20];
	FILE *f;
